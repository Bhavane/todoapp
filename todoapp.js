...
let todosCount = TaskList.length;
...
function onTodoStatusChange(checkboxId, labelId, todoId) {
    ...
    let todoObjectIndex = TaskList.findIndex(function(eachTodo) {
    ...
    let todoObject = TaskList[todoObjectIndex];
...
function onDeleteTodo(todoId) {
    ...
    taskItemsContainer.removeChild(todoElement);

    let deleteElementIndex = TaskList.findIndex(function(eachTodo) {
        let eachTodoId = "todo" + eachTodo.uniqueNo;
        if (eachTodoId === todoId) {
            return true;
        } else {
...
function createAndAppendTodo(todo) {
    ...
    taskItemsContainer.appendChild(todoElement);
